...
// results 에서 vote_average가 8 이상이면 title 출력

// function Vote(results) {
//     for (let vote of results['vote_average']){
//         return vote
//     }
// }

const Voteaver = function(results) {
    for (let vote of results['vote_average']){
        return vote
    }
}

// movieInfo = {"results" : [{},{vote_average : values},,,,{}]},{},{},,
for (let results of movieInfo['results']){
    console.log((results)) //results : 각 영화의 결과
}
